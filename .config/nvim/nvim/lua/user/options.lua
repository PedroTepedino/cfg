...
local options = {
    ...
    ignorecase = true, 	                  	  -- ignore case inm search patterns
    mouse = "a",				                      -- allow the mouse to be used in neovim
    pumheight = 10,                           -- pop up menu height
    showmode = false,                         -- we don't need tp see things like -- INSERT --  anymore
...
-- Set Filetype detection (it s the default options)
